...
namespace EEQG.Tools
{
    ...
    /// </summary>
    [Serializable]
    public class EFSeriousStringCollection : EFSeriousCollection<string>
    {
        public EFSeriousStringCollection() : base()
        {

        }
        public EFSeriousStringCollection(List<string> list) : base(list)
        {
    ...
    public abstract class EFSeriousCollection<T> : ICollection<T> where T : class
    {
        ...
        public EFSeriousCollection()
        {
            Data = new List<T>();
        }
        public EFSeriousCollection(List<T> arr)
        {
            Data = arr;
        }
        /// <summary>
